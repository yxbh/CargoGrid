...
Braces have physical centre spacings of 60 or 120 mm and overall bounds 78/138 x 18 x 6.4 mm. Their capsule ends are R9, top edges R1 and bottom chamfer 0.4 mm. Each bore has 5.6 mm straight depth plus a 0.4 mm lead at each mouth. Size and bore labels are part of the solid. The catalogue includes only the two nominal Ø10 mm braces; Ø10.2 and Ø10.4 mm remain individual-part options. Neither spacing nor bore diameter scales with unit size.

The 10.0, 10.2 and 10.4 mm bores provide nominal diametral clearances of 0, 0.2 and 0.4 mm over a 10 mm shaft; radial clearance is half those values. Zero CAD clearance is not a promise of a printed slip fit. For standard tiles, a 60 mm pair is (30,60) to (90,60) within one 2x2 tile. A 120 mm pair is (60,30) to (180,30) across two ordinary 2x1 tiles, with the second body origin translated 120 mm along X. These are complete round holes checked in the generated tile solids, not X openings or exposed half-holes. Check the chosen holes on a custom mat rather than assuming every half-unit grid site is usable.
...
The user completed the 120/240 mm rod test print and reported that the nominal 10 mm rod/peg-to-mat fit was fine with PETG, a 0.8 mm nozzle and 0.32 mm layers. That report applies to the tested horizontal rod pose and standard 13 mm tile thickness; no measured diameter, insertion force or filament brand was supplied. The user also accepted nominal Ø10 mm brace bores provisionally while confirming that the braces had not been tested. Brace grip, custom fit and load performance remain untested. Bags rest on the mat; a friction-fit brace may slide or jam and is not a positive height lock.
